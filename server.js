...
app.use(
  "/dashboard/cadastrar-admin",
  express.static(resolve(__dirname, "./build"))
);
app.use(
  "/dashboard/consultar-admin",
  express.static(resolve(__dirname, "./build"))
);
app.use(
  "/dashboard/atualizar-admin/:id",
  express.static(resolve(__dirname, "./build"))
);
app.use(
...
app.use(
  "/dashboard/atualizar-fornecedor/:id",
  express.static(resolve(__dirname, "./build"))
);
app.use(
...
app.use(
  "/dashboard/consultar-produtos",
  express.static(resolve(__dirname, "./build"))
);
app.use(
  "/dashboard/atualizar-produto/:id",
  express.static(resolve(__dirname, "./build"))
);
